...
row_dragging_over = (e) => {
  ...
  table_freeze(){
    function style_marge(c_style, freeze_style) {
        if (freeze_style == "") {
               // c_style  freeze_style delete
	} else {
               // c_style  freeze_styleupdata 
	}
    }
    for ( let i = 0; i <this.table.childNodes.length ; i ++) {
      if (this.table.childNodes[i].nodeName == "TR") {
          //console.log("TR",i);
          //this.table.childNodes[i].style += this.freezeStyle_tr(i);
...
*/
  ...
  init(json) {
    ...
    //let ele = this.container.querySelector("#TD_1_1" );
    //let ele = document.querySelector("#container4" );
    //let ele = this.container.querySelector("#TD_1_1");
...
/*
  ...
  */
  ...
  sum_top_height(r) {
     ...
     for ( let i = 0 ; i < r ; i++) {
      ...
      //let ele = this.container.querySelector('#' + tdid);
      //console.log(ele);
 ...
 freezeStyle_tr(r) {
  ...
  freezeStyle_td(c,r) {
     ...
     if (this.isrFreeze()) {
           if ( c < this.freeze_decoded.c ) {
		//console.log("freezeStyle_td",c, r);
                let leftwidth = this.sum_left_width(c)
                //if ( leftwidth != 0) {
